...
const Resumegen2 = () => {
  ...
  const handleFormSubmit = async(data) =>{
    ...
    await axios.post("https://backend-1p2y.onrender.com/api/resumes", {
      userId:userId,
      templateId: 2, // Replace with actual template ID selected by the user
      formData: data,
    });
  };
    ...
    pdf.html(element, {
      callback: (doc) => {
        ...
        links.forEach((link) => {
          ...
          const y = (rect.top - element.offsetTop) * scale + 10; // Adjust for margins
  ...
  >
    ...
    <line x1="12" x2="12" y1="15" y2="3"></line>
         ...
         <div className="text-center">
            <button                      type="submit"
       onClick={handleDownloadPDF}                    style={{ backgroundColor: "#29E33C" }}  
