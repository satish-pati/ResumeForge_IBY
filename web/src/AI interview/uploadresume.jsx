...
const UploadResumeAi = () => {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      navigate("/AiInterview", { state: { resumeData: response.data } });
    } catch (error) {
...
const UploadResumeAi= () => {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      setTimeout(() => navigate("/aiinterviewprev"), 1000);
    } catch (error) {
    ...
    <div className="relative isolate overflow-hidden bg-gray-900">
      ...
      <header className="bg-white/10 dark:bg-gray-700 shadow-md py-6">
        <div className="container mx-auto px-4">
          ...
          Prepare for your next job interview with our AI-powered tool
          </p>
        </div>
      </header>
      ...
      >
        ...
        <div className=" mt-0 pt-0 mx-auto max-w-2xl lg:mx-0 lg:max-w-xl lg:pt-8">
          ...
          Master Interviews with AI-Driven Practice
          </h1>
          <p className="mt-6 text-lg leading-8 text-gray-300">
          Elevate your interview skills with our cutting-edge Voice-to-Voice AI Mock Interview platform. Practice with realistic, industry-specific scenarios and receive instant, actionable feedback to boost your confidence and performance.
          </p>
          <form
           onSubmit={(e) => {
  ...
  <div className="flex flex-col space-y-1.4 p-4">
    ...
    <h3 className="text-xl font-semibold leading-none tracking-tight">Intelligent Question Generation</h3>
  </div>
  <div className="text-xs p-4 pt-0">
    <p className="text-white">Our AI analyzes your job description and resume to create tailored, industry-specific questions.</p>
  </div>
</div>
<div className="w-80 h-42 rounded-lg border bg-card text-white shadow-sm">
  <div className="flex flex-col space-y-1.4 p-4">
    ...
    <h3 className="text-xl font-semibold leading-none tracking-tight">Personalized Feedback</h3>
  </div>
  <div className="text-xs p-4 pt-0">
    <p className="text-white">Receive instant, detailed feedback on your responses to help you improve your interview performance.</p>
  </div>
</div>
<div className="w-80 h-42 rounded-lg border bg-card text-white shadow-sm">
  <div className="flex flex-col space-y-1.4 p-4">
    ...
    <h3 className="text-xl font-semibold leading-none tracking-tight">Real-time Practice</h3>
  </div>
  <div className="text-xs p-4 pt-0">
    <p className="text-white">Experience a realistic interview environment with our AI interviewer, helping you build confidence.</p>
  </div>
</div>
</div>
</section>
