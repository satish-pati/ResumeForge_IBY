...
const UploadResumeInterview = () => {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      localStorage.setItem("uploadedResumeName", fileName); // Store in localStorage or a state variabl  
      setTimeout(() => navigate("/InterviewQuestionGenerate"), 1000);
    } catch (error) {
    ...
    <div className="relative isolate overflow-hidden bg-gray-900">
      ...
      >
        ...
        <div className=" mt-0 pt-0 mx-auto max-w-2xl lg:mx-0 lg:max-w-xl lg:pt-8">
          ...
          Enhance Your Interview Preparation with AI-Powered Questions

          </h1>
          <p className="mt-6 text-lg leading-8 text-gray-300">
          Leverage our advanced technology to generate intelligent, personalized interview questions based on job roles and descriptions. Optimize your preparation and ace your interviews with confidence.
...
<div className="w-80 h-42 rounded-lg border bg-card text-white shadow-sm">
  <div className="flex flex-col space-y-1.4 p-4">
    <div className="w-9 h-9 rounded-full bg-green-500 flex items-center justify-center mb-4">
      ...
      >
        <path d="M19 7c-3 0-4 2-4 4s1 4 4 4" />
        <path d="M5 7c3 0 4 2 4 4s-1 4-4 4" />
        <path d="M12 12v4" />
      </svg>
    </div>
    <h3 className="text-xl font-semibold leading-none tracking-tight">AI Question Generator</h3>
  </div>
  <div className="text-xs p-4 pt-0">
    <p className="text-white">Generate customized interview questions based on the job role and skill set.</p>
  </div>
</div>

{/* Card 2: Customize Question Difficulty */}
<div className="w-80 h-42 rounded-lg border bg-card text-white shadow-sm">
  <div className="flex flex-col space-y-1.4 p-4">
    <div className="w-9 h-9 rounded-full bg-green-500 flex items-center justify-center mb-4">
      <svg
        ...
        strokeLinecap="round"
        strokeLinejoin="round"
        className="lucide lucide-sliders w-6 h-6 text-white"
      >
        <path d="M4 6h16" />
        <path d="M4 12h16" />
        <path d="M4 18h16" />
    ...
    <h3 className="text-xl font-semibold leading-none tracking-tight">Customize Question Difficulty</h3>
  </div>
  <div className="text-xs p-4 pt-0">
    <p className="text-white">Adjust the difficulty level of interview questions based on your preparation.</p>
  </div>
</div>
  ...
  <div className="flex flex-col space-y-1.4 p-4">
    <div className="w-9 h-9 rounded-full bg-green-500 flex items-center justify-center mb-4">
      <svg
        ...
        strokeLinecap="round"
        strokeLinejoin="round"
        className="lucide lucide-chat-check w-6 h-6 text-white"
      >
        <path d="M3 16c0 3 3 3 6 3h6c3 0 6-3 6-3V8c0-3-3-3-6-3H9c-3 0-6 3-6 3v8z" />
        <path d="M12 12l2 2 4-4" />
      </svg>
    </div>
    <h3 className="text-xl font-semibold leading-none tracking-tight">Get Real-Time Feedback</h3>
  </div>
  <div className="text-xs p-4 pt-0">
    <p className="text-white">Receive immediate feedback on your answers to improve your interview performance.</p>
  </div>
</div>
</div>
</section>
...
export default UploadResumeInterview;
